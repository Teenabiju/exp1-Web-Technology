...
function fruit() {
 ...
 const img = ["https://images.pexels.com/photos/2487443/pexels-photo-2487443.jpeg?cs=srgb&dl=pexels-matheus-cenali-2487443.jpg&fm=jpg", "https://cdn.britannica.com/24/174524-050-A851D3F2/Oranges.jpg"]
...
function flip() {
 const idx = Math.floor(Math.random() * 2);
 const img = ["https://images.pexels.com/photos/2487443/pexels-photo-2487443.jpeg?cs=srgb&dl=pexels-matheus-cenali-2487443.jpg&fm=jpg","https://thumbs.dreamstime.com/b/one-rupee-coin-shiny-white-background-30801135.jpg"]
 if (idx == 0)
 hc += 1;
 else
 tc += 1;
